"""
Data generation and preprocessing module for English version
"""
...
from config_en import DATA_CONFIG
...
class EnglishSentimentDataGenerator:
    ...
    def __init__(self, sample_size: int = DATA_CONFIG['sample_size']):
        ...
        self.negative_reviews = [
            ...
            "Bad service and poor product.",
            "Worst purchase ever, avoid this.",
            "Disappointing quality, not worth it.",
            "Poor design and lack of functionality.",
    ...
    def _generate_variations(self, base_reviews: List[str], count: int) -> List[str]:
        ...
        for _ in range(count):
            ...
            variations = [
                ...
                f"Absolutely {base}",
                f"{base} Without a doubt.",
                f"Clearly {base}",
                f"{base} No question about it.",
                f"Obviously {base}",
                f"{base} For sure."
            ]
